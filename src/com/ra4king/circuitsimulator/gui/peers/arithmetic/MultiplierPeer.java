...
import com.ra4king.circuitsimulator.simulator.components.arithmetic.Multiplier;
...
public class MultiplierPeer extends ComponentPeer<Multiplier> {
	public static void installComponent(ComponentManagerInterface manager) {
		manager.addComponent(new Pair<>("Arithmetic", "Multiplier"),
		                     new Image(MultiplierPeer.class.getResourceAsStream("/resources/Multiplier.png")),
		                     new Properties());
	}
	...
	public MultiplierPeer(Properties props, int x, int y) {
		...
		Multiplier multiplier = new Multiplier(properties.getValue(Properties.LABEL),
		...
		connections.add(
				new PortConnection(this, multiplier.getPort(Multiplier.PORT_OUT_UPPER), "Upper bits", 2, getHeight()));
