...
public class SubcircuitTest {
	public static void main(String[] args) {
		...
		Adder adder = circuit.addComponent(new Adder(circuit, "", 4));
		Pin inA = circuit.addComponent(new Pin(circuit, "A", 4));
		Pin inB = circuit.addComponent(new Pin(circuit, "B", 4));
		Pin inC = circuit.addComponent(new Pin(circuit, "C", 1));
		Pin out = circuit.addComponent(new Pin(circuit, "Out", 4));
		...
		Subcircuit subcircuit = circuit2.addComponent(new Subcircuit(circuit2, "", circuit));
		Pin in2A = circuit2.addComponent(new Pin(circuit2, "A2", 4));
		Pin in2B = circuit2.addComponent(new Pin(circuit2, "B2", 4));
		Pin in2C = circuit2.addComponent(new Pin(circuit2, "C2", 1));
		Pin out2 = circuit2.addComponent(new Pin(circuit2, "Out2", 4));
