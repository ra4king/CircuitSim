...
public class SRFlipFlopPeer extends ComponentPeer<SRFlipFlop> {
	...
	public SRFlipFlopPeer(Properties props, int x, int y) {
		...
		SRFlipFlop flipFlop = new SRFlipFlop(props.getValue(Properties.LABEL));
	...
	public void paint(GraphicsContext graphics, CircuitState state) {
		...
		graphics.setStroke(Color.BLACK);
		graphics.strokeLine(x, y + height * 0.5 - 3, x + 6, y + height * 0.5);
		graphics.strokeLine(x + 6, y + height * 0.5, x, y + height * 0.5 + 3);
	}
}
